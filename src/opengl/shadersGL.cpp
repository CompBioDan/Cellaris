...
void DrawBacteria(Vec4* positions, int* indices, int numIndices, float radius, Vec3 color)
{
	if (numIndices < 2)
		return;
	...
	glVerify(glColor3fv(Colour(color.x, color.y, color.z) * 1.5f));
	glVerify(glSecondaryColor3fv(Colour(color.x, color.y, color.z) * 1.5f));
...
void DrawRopeCell(Vec4* positions, int* indices, int numIndices, float radius, int color)
{
	if (numIndices < 2)
		return;
...
void DrawBacteriaCell(Vec4* positions, int* indices, int numIndices, float radius, Vec3 color)
{
	if (numIndices < 2)
		return;
